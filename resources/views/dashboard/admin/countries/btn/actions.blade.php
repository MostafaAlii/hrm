<div class="d-flex justify-content-center">
    ...
    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
        data-bs-target="#editBranchModal{{ $country->id }}">
        <i class="fas fa-edit"></i>
    </button>

    <!-- Modal Edit -->
    <div class="modal fade" id="editBranchModal{{ $country->id }}" tabindex="-1"
        aria-labelledby="editBranchLabel{{ $country->id }}" aria-hidden="true">
            ...
            <form action="{{ route('admin.country.update', $country->id) }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editBranchLabel{{ $country->id }}">تعديل  الدوله
                        </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" name="is_active" class="form-check-input" value="1"
                                id="is_active_edit{{ $country->id }}" {{ $country->is_active ? 'checked'
                            : '' }}>
                            <label class="form-check-label" for="is_active_edit{{ $country->id }}">مفعل</label>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="text-center modal-body">
                    <p>هل أنت متأكد من حذف "<strong>{{ $country->name_ar }}</strong>"؟</p>
