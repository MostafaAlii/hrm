...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">{{trans('dashboard/sidebar.country_page_title') }}</h1>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('admin.country.index')}}">{{
                    trans('dashboard/sidebar.country_sidebar_title') }}</a>
            </li>
        </ul>
    </div>
    <!-- Start Content -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @include('dashboard.admin.countries.btn.create')
                </div>
                <div class="card-body">
