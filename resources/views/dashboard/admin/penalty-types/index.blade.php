...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">الجزاءات</h1>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('admin.dashboard')}}">{{trans('dashboard/header.main_dashboard') }}</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('admin.penalty-types.index')}}">
                    الجزاءات
                </a>
            </li>
        </ul>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button data-pc-animate="3d-sign" type="button" class="btn btn-sm btn-light btn-active-primary"
                        data-bs-toggle="modal" data-bs-target="#createPenaltyModal">
                        <i class="fa fa-plus"></i>
                        اضافه جزاء
                    </button>
                    @include('dashboard.admin.penalty-types.btn.create')
                </div>
                <div class="card-body">
