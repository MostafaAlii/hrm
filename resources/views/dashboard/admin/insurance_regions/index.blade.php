...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">{{trans('dashboard/sidebar.insurance_region_page_title') }}</h1>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('admin.dashboard')}}">{{trans('dashboard/header.main_dashboard') }}</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('admin.insurance-regions.index')}}">{{
                    trans('dashboard/sidebar.insurance_region_sidebar_title') }}</a>
            </li>
        </ul>
    </div>
    <!-- Start Content -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button data-pc-animate="3d-sign" type="button" class="btn btn-sm btn-light btn-active-primary"
                        ...
                        {{trans('dashboard/insurance_region.add_new_insurance_region')}}
                    </button>
                    @include('dashboard.admin.insurance_regions.btn.create')
                </div>
                <div class="card-body">
