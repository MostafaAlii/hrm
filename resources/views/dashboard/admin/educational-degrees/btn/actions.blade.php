<div class="d-flex justify-content-center">
    ...
    <div class="modal fade" id="editBranchModal{{ $record->id }}" tabindex="-1"
        ...
        <div class="modal-dialog">
            <form action="{{ route('admin.educational-degrees.update', $record->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editBranchLabel{{ $record->id }}">تعديل نوع المؤهل
                        </h5>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="text-center modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إلغاء</button>
                        <form action="{{ route('admin.educational-degrees.destroy', $record->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
