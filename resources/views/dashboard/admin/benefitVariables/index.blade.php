...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">{{trans('dashboard/sidebar.benefitVariable_page_title') }}</h1>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('admin.dashboard')}}">{{trans('dashboard/header.main_dashboard') }}</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('admin.benefitVariable.index')}}">{{
                    trans('dashboard/sidebar.benefitVariable_sidebar_title') }}</a>
            </li>
        </ul>
    </div>
    <!-- Start Content -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button data-pc-animate="3d-sign" type="button" class="btn btn-sm btn-light btn-active-primary"
                        ...
                        {{trans('dashboard/benefitVariable.add_new_benefitVariable')}}
                    </button>
                    @include('dashboard.admin.benefitVariables.btn.create')
                </div>
                <div class="card-body">
