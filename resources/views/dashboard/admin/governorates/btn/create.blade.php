        ...
        <form action="{{ route('admin.governorate.store') }}" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createBranchLabel">إضافة متغيرات محافظه جديده</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="transportation_allowance" class="form-control" value="0" required>
                    </div>
