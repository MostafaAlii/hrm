...
<div class="modal fade" id="createInsuranceOfficeModal" tabindex="-1" aria-labelledby="createInsuranceOfficeLabel"
    ...
    <div class="modal-dialog">
        <form action="{{ route('admin.insurance-types.store') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createInsuranceOfficeLabel">إضافة نوع تامين جديد</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="employee_percentage" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">نسبه الشركه</label>
                        <input type="text" name="company_percentage" class="form-control">
                    </div>
