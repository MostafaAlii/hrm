...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">{{trans('dashboard/sidebar.insurance_type_page_title') }}</h1>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('admin.insurance-types.index')}}">{{
                    trans('dashboard/sidebar.insurance_type_sidebar_title') }}</a>
            </li>
        </ul>
    </div>
    <!-- Start Content -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button data-pc-animate="3d-sign" type="button" class="btn btn-sm btn-light btn-active-primary"
                        ...
                        {{trans('dashboard/insurance_type.add_new_insurance_type')}}
                    </button>
                    @include('dashboard.admin.insurance_types.btn.create')
                </div>
                <div class="card-body">
