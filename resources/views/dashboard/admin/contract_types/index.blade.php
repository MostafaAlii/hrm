...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">{{trans('dashboard/sidebar.contract_type_page_title') }}</h1>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('admin.contract-types.index')}}">{{
                    trans('dashboard/sidebar.contract_type_sidebar_title') }}</a>
            </li>
        </ul>
    </div>
    <!-- Start Content -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button data-pc-animate="3d-sign" type="button" class="btn btn-sm btn-light btn-active-primary"
                        ...
                        {{trans('dashboard/contract_type.add_new_contract_type')}}
                    </button>
                    @include('dashboard.admin.contract_types.btn.create')
                </div>
                <div class="card-body">
