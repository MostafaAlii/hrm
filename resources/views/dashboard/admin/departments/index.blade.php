...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">{{trans('dashboard/sidebar.department_page_title') }}</h1>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('admin.departments.index')}}">{{
                    trans('dashboard/sidebar.department_sidebar_title') }}</a>
            </li>
        </ul>
    </div>
    <!-- Start Content -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button data-pc-animate="3d-sign" type="button" class="btn btn-sm btn-light btn-active-primary"
                        ...
                        {{trans('dashboard/department.add_new_department')}}
                    </button>
                    @include('dashboard.admin.departments.btn.create')
                </div>
                <div class="card-body">
