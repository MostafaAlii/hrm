...
class CostCenterDataTable extends BaseDataTable
{
    ...
    {
        parent::__construct(new CostCenter);
    ...
    public function dataTable($query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (CostCenter $record) {
                return view('dashboard.admin.costCenters.btn.actions', compact('record'));
            })
            ->editColumn('created_at', function (CostCenter $record) {
                return $this->formatTranslatedDate($record->created_at);
            })
            ->editColumn('updated_at', function (CostCenter $record) {
                return $this->formatTranslatedDate($record->updated_at);
            })
            ->addColumn('responsible', function (CostCenter $record) {
    ...
    public function query(): QueryBuilder
    {
        ...
        return CostCenter::where('company_id', $user)->latest();
    }
