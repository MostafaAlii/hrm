...
class EducationalDegreeDataTable extends BaseDataTable
{
    public function __construct(DataTableRequest $request)
    {
        parent::__construct(new EducationalDegree);
    ...
    public function dataTable($query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (EducationalDegree $record) {
                return view('dashboard.admin.educational-degrees.btn.actions', compact('record'));
            })
            ->editColumn('created_at', function (EducationalDegree $record) {
                return $this->formatTranslatedDate($record->created_at);
            })
            ->editColumn('updated_at', function (EducationalDegree $record) {
                return $this->formatTranslatedDate($record->updated_at);
            })
            ->addColumn('responsible', function (EducationalDegree $record) {
    ...
    public function query(): QueryBuilder
    {
        ...
        return EducationalDegree::where('company_id', $user)->latest();
    }
