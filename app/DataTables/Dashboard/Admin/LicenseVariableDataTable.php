...
class LicenseVariableDataTable extends BaseDataTable
{
    public function __construct(DataTableRequest $request)
    {
        parent::__construct(new LicenseVariable);
    ...
    public function dataTable($query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (LicenseVariable $record) {
                return view('dashboard.admin.licenseVariable.btn.actions', compact('record'));
            })
            ->editColumn('created_at', function (LicenseVariable $record) {
                return $this->formatTranslatedDate($record->created_at);
            })
            ->editColumn('updated_at', function (LicenseVariable $record) {
                return $this->formatTranslatedDate($record->updated_at);
            })
            ->addColumn('responsible', function (LicenseVariable $record) {
    ...
    public function query(): QueryBuilder
    {
        ...
        return LicenseVariable::where('company_id', $user)->latest();
    }
