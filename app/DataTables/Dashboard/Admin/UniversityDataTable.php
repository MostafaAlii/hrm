...
class UniversityDataTable extends BaseDataTable
{
    public function __construct(DataTableRequest $request)
    {
        parent::__construct(new University);
    ...
    public function dataTable($query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (University $record) {
                return view('dashboard.admin.universities.btn.actions', compact('record'));
            })
            ->editColumn('created_at', function (University $record) {
                return $this->formatTranslatedDate($record->created_at);
            })
            ->editColumn('updated_at', function (University $record) {
                return $this->formatTranslatedDate($record->updated_at);
            })
            ->addColumn('responsible', function (University $record) {
    ...
    public function query(): QueryBuilder
    {
        ...
        return University::where('company_id', $user)->latest();
    }
